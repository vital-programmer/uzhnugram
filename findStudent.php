    ...
    <div class = "col2">
        ...
        try {
            ...
            while($row = $query->fetch())
                ...
                echo "<br> <p class = \"name\">".$row["name"]." ".$row["surname"]
                    ."</p> <img class = \"userpic\" src = \""
                    ."$image_path"."\" alt = \"Фото особи\">"."</p> <p  class = \"achievements\">".$row["achievements"]
                    ."</p> <p class = \"about\">".$row["about"]."</p> <p class = \"social\"> <img class = \"networkpic\" 
                    src=\"images\Instagram_icon.png\"> <a title=\"Сторінка в Instagram\" href = \"".$row["instagram"]
                    ."\">".$row["instagram"]."</a></p> <p class = \"social\"> <img class = \"networkpic\"
                    src=\"images\Facebook_icon.png\"> <a title=\"Сторінка у Facebook\" href = \"".$row["facebook"]
                    ."\">".$row["facebook"]."</a> </p> <br> <hr>";
                 }
        }
